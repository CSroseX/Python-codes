...
#calculating user_score and comp_score
user_score = 0
comp_score = 0
def calculate_user_score(a,b):
    user_score = a+b
    return user_score

# def calculate_comp_score(comp_first_card,comp_second_card):
#     comp_score = int(comp_first_card)+int(comp_second_card)
#     return comp_score
...
a= int(user_first_card)
b= int(user_second_card)
calculate_user_score(a,b)
# calculate_comp_score(int(comp_first_card),int(comp_second_card))
print (user_score)
print (comp_score)
